...
# psql--host='database-1.ciwtxtgqt2xy.us-east-2.rds.amazonaws.com' --port='5432' --username='postgres' --password
# --dbname='postgres' Sensitive information has been encrypted
DATABASES = {
    'default': {
